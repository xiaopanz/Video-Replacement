...
int main(int argc, char **argv) {
  ...
  std::vector<std::pair<size_t, size_t>> ads_intervals = {{2400, 2849},
                                                          {5550, 5999}};
  ...
  const std::string starbuck_logo_path =
      "data/dataset-001/dataset/Brand Images/starbucks_logo.rgb";
  const std::string subway_logo_path =
      "data/dataset-001/dataset/Brand Images/subway_logo.rgb";

  const std::string starbuck_ads_path =
      "data/dataset-001/dataset/Ads/Starbucks_Ad_15s.rgb";
  const std::string subway_ads_path =
      "data/dataset-001/dataset/Ads/Subway_Ad_15s.rgb";
  ...
  auto subway_logo_boxes = detect_subway_v2::FindLogo(
